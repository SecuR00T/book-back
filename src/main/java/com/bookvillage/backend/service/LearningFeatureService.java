...
public class LearningFeatureService {
    ...
    public void addCartItem(Long userId, Long bookId, Integer quantity, BigDecimal providedPrice) {
        ...
        // Use client-supplied price if provided; server does not validate against actual book price.
        BigDecimal unitPrice = (providedPrice != null) ? providedPrice : book.getPrice();
